...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" src="img/qd_cachimbo.png?v=' + V + '" alt="">' + '' + '</div>' + '<i class="elo"></i>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" src="img/qd_jarro.png?v=' + V + '" alt="">' + '' + '</div>' + '<i class="elo"></i>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" src="img/qd_sino.png?v=' + V + '" alt="">' + '' + '</div>' + '<i class="elo"></i>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" src="img/qd_touro.png?v=' + V + '" alt="">' + '' + '</div>' + '</div>' +
