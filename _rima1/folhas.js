...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="barra"></div><div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<i class="fio"></i><img class="cf" draggable="false" src="img/ri_gato.png?v=' + V + '" alt="">' + '<span class="rt">GATO</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<i class="fio"></i><img class="cf" draggable="false" src="img/ri_pato.png?v=' + V + '" alt="">' + '<span class="rt">PATO</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<i class="fio"></i><img class="cf" draggable="false" src="img/ri_bola.png?v=' + V + '" alt="">' + '<span class="rt">BOLA</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<i class="fio"></i><img class="cf" draggable="false" src="img/ri_cebola.png?v=' + V + '" alt="">' + '<span class="rt">CEBOLA</span>' + '</div>' + '</div>' + '' +
