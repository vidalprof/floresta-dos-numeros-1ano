...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena"><i class="aro"></i><div class="miolo">L</div><div class="cporbe">' + '<div class="it" style="left:50.0%;top:8.0%">' + '<img class="capfig" draggable="false" src="img/ro_lata.png?v=' + V + '" alt="">' + '<span class="rt">LA</span>' + '</div>' + '<div class="it" style="left:89.9%;top:37.0%">' + '<img class="capfig" draggable="false" src="img/ro_leao.png?v=' + V + '" alt="">' + '<span class="rt">LE</span>' + '</div>' + '<div class="it" style="left:74.7%;top:84.0%">' + '<img class="capfig" draggable="false" src="img/ro_limao.png?v=' + V + '" alt="">' + '<span class="rt">LI</span>' + '</div>' + '<div class="it" style="left:25.3%;top:84.0%">' + '<img class="capfig" draggable="false" src="img/ro_lobo.png?v=' + V + '" alt="">' + '<span class="rt">LO</span>' + '</div>' + '<div class="it" style="left:10.1%;top:37.0%">' + '<img class="capfig" draggable="false" src="img/ro_lupa.png?v=' + V + '" alt="">' + '<span class="rt">LU</span>' + '</div>' + '</div></div>' +
