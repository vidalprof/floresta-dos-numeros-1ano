...
| Atividade | O que trabalha | Pasta | Link |
|---|---|---|---|
| **A Oficina do Material Dourado** (livro de folhas · 5º ano) | Matemática (divisão com material dourado — EF05MA07): 10 folhas interativas em sequência — valor das peças (ligar), qual é o número, montar em C/D/U, repartir igual em grupos, a TROCA do "abaixa", divisão com resto, a conta armada na chave, ligar conta ao resultado, problemas do dia a dia e a prova real. As peças (cubinho, barra, placa, cubão) são desenhadas em SVG pela casa, em 3D; cada abertura sorteia itens novos; voz em toda folha, teclado na tela e de verdade, continua de onde parou por 55 min | `_dourado5` | https://vidalprof.github.io/oficina-do-material-dourado/ |
