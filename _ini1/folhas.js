...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="cf" draggable="false" src="img/in_bola.png?v=' + V + '" alt="">' + '<span class="rt">BO</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="cf" draggable="false" src="img/in_bolo.png?v=' + V + '" alt="">' + '<span class="rt">BO</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="cf" draggable="false" src="img/in_boneca.png?v=' + V + '" alt="">' + '<span class="rt">BO</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="cf" draggable="false" src="img/in_bota.png?v=' + V + '" alt="">' + '<span class="rt">BO</span>' + '</div>' + '<div class="it" style="animation-delay:1.40s">' + '<img class="cf" draggable="false" src="img/in_boca.png?v=' + V + '" alt="">' + '<span class="rt">BO</span>' + '</div>' + '</div><div class="terra"></div>' +
