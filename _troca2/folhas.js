...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="par">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mq_gato.png?v=' + V + '" alt="">' + '<span class="rt">GA-TO</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mq_pato.png?v=' + V + '" alt="">' + '<span class="rt">PA-TO</span>' + '</div>' + '</div>' + '<div class="par">' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mq_lata.png?v=' + V + '" alt="">' + '<span class="rt">LA-TA</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mq_lama.png?v=' + V + '" alt="">' + '<span class="rt">LA-MA</span>' + '</div>' + '</div>' + '</div>' +
