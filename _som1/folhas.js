...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena"><i class="foco"></i>' + '<div class="it" style="animation-delay:0.00s">' + '<img class="cf" draggable="false" src="img/so_bola.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="cf" draggable="false" src="img/so_boneca.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="cf" draggable="false" src="img/so_bota.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="cf" draggable="false" src="img/so_banana.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '</div><div class="prat"></div>' +
