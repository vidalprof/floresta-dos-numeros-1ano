...
echo "      e o pre-voo reprova em QUATRO portoes — os quatro dizendo a mesma coisa,"
...
echo "        · 0b11 identidade -> a capa e a cor ainda sao as do esqueleto: REDESENHE"
echo "          (:root --cor/--cor2/--corclara + bloco A CAPA + f0 do folhas.js, pelo ASSUNTO)"
