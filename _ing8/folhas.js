...
function f0(d){
  ...
  var c = el("div", "capa"), nome = "Aprendendo some, any, much, many e os pronomes relativos", k, letras = "", pos = 0;
  ...
  c.innerHTML =
    ...
    '<div class="cpbarra"></div><div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/lf_suitcase.png?v=' + V + '" alt="">' + '' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/lf_mouse.png?v=' + V + '" alt="">' + '' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/lf_tea.png?v=' + V + '" alt="">' + '' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<i class="fio"></i><img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/lf_music.png?v=' + V + '" alt="">' + '' + '</div>' + '</div>' + '<div class="balcao">LOST &amp; FOUND</div>' +
