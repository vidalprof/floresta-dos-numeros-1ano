...
- **Screenshot headless pode não bater com o viewport real** (layout a 500px): medir `innerWidth`/`scrollWidth` antes de "consertar" um falso overflow; `max-width:100%` funciona.
