...
F.update({
    ...
    "p6enun": u"Um número pode ser feito de vários jeitos! Olhe a mão, veja quanto falta para chegar ao número da ponta e digite. Depois repare: quando um lado sobe, o outro desce.",
