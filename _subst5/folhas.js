...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/sb_ana.png?v=' + V + '" alt="">' + '<span class="rt">Ana</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/sb_davi.png?v=' + V + '" alt="">' + '<span class="rt">Davi</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/sb_brasil.png?v=' + V + '" alt="">' + '<span class="rt">Brasil</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/sb_pluto.png?v=' + V + '" alt="">' + '<span class="rt">Pluto</span>' + '</div>' + '</div>' + '<div class="esteira2">' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '<i class="rolo"></i>' + '</div>' +
