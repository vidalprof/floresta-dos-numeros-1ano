...
- **Conquistas/selos** (imagens do tema, nunca emoji) em marcos: 1º acerto, 5 seguidos (streak), 1ª fase, metade, jogo, todas. *(No Circo do Teo: streak/pop e a base de estado já existem; os SELOS-imagem ficam pendentes até a cartela do ChatGPT — daí liga-se `checarConquistas()` que destrava o selo com pop + `enfileirarFala`.)*
