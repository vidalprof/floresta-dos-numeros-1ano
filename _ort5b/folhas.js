...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="cf" draggable="false" src="img/ls_sapo.png?v=' + V + '" alt="">' + '<span class="rt">S</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="cf" draggable="false" src="img/ls_sino.png?v=' + V + '" alt="">' + '<span class="rt">S</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="cf" draggable="false" src="img/ls_osso.png?v=' + V + '" alt="">' + '<span class="rt">SS</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="cf" draggable="false" src="img/ls_passaro.png?v=' + V + '" alt="">' + '<span class="rt">SS</span>' + '</div>' + '</div><div class="tabu"></div>' +
