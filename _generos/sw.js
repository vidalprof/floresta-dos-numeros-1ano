...
var CACHE="generos-banca-v1";
var ATIVOS=["./","./index.html","./manifest.json",
 "./img/vb_fundo.jpg","./img/vb_pingo.png","./img/vb_pingo_fala.png","./img/vb_pingo_pisca.png",
 "./img/vb_jornal.png","./img/vg_poema.png","./img/vg_conto.png","./img/vg_carta.png",
 "./img/vg_verbete.png","./img/vg_med.png",
 "./audio/vg_abertura.mp3","./audio/vg_p1_intro.mp3","./audio/vg_p1_prever.mp3"];
