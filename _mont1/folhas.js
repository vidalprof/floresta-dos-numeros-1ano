...
function f0(d){
  /* CAPA COM IDENTIDADE PRÓPRIA — gerada por _padrao/identidade_capa.py (editar lá).
     Cena: a máquina de juntar: os dois pedaços deslizam e se encaixam. O título entra letra a letra (desliza), palavra por palavra
     (nowrap, para não quebrar no meio); as figuras são as do próprio caderno. */
  var c = el("div", "capa"), nome = "A MÁQUINA DE JUNTAR PALAVRAS", k, letras = "", pos = 0;
  ...
  c.innerHTML =
    ...
    '<div class="cena">' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mo_bola.png?v=' + V + '" alt="">' + '<span class="rt">BO·LA</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mo_gato.png?v=' + V + '" alt="">' + '<span class="rt">GA·TO</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mo_pipa.png?v=' + V + '" alt="">' + '<span class="rt">PI·PA</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/mo_sino.png?v=' + V + '" alt="">' + '<span class="rt">SI·NO</span>' + '</div>' + '</div><div class="engr"></div>' +
