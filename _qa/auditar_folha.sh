...
echo
echo " ⚠️ O QUE NENHUM PORTAO MEDE AINDA (divida da casa, tarefa #104):"
echo "    · a escada didatica — se as folhas SOBEM de verdade;"
echo "    · o leque de gestos — se algum gesto passa de 40% do caderno."
echo "    Hoje quem responde por isso e o crivo escrito do _sequencias/POTE-*.md,"
echo "    que e do Claude e NAO e medida. Nao confundir com aprovacao."
if [ -n "$REPROVOU" ]; then
  echo
