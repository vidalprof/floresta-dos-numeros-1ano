...
PREFIXO = u"sn3_"                     # <- o prefixo desta atividade
...
# ---------------------------------------------------------------------------
p(u"capa", u"Aprendendo o sistema de numeração decimal: trocas, valor de lugar e decomposição. N folhas sobre ASSUNTO. Escreva o seu nome ali "
