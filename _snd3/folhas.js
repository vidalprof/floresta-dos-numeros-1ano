...
function f0(d){
  ...
  var c = el("div", "capa"), nome = "Aprendendo o sistema de numeração decimal: trocas, valor de lugar e decomposição", k, letras = "";
...
function fim(){
  ...
  for(ke = 0; ke < 3; ke++)
    est += '<img src="img/sn3_selo' + (ke < cheias ? "" : "_off") + '.png?v=' + VIMG + '" alt="" draggable="false">';
