...
ENUN = {
    ...
    13: u"Agora os reinos que não se veem a olho nu. De qual deles é este ser?",
    14: u"Ligue cada ser vivo ao reino dele.",
    15: u"Agora a planta e os minúsculos na mesma folha. Ligue cada um ao reino dele.",
    16: u"Marque as três características deste reino.",
    17: u"Agora a coroa dos minúsculos. Marque as três características deste reino.",
