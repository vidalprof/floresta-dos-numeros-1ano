...
- **Transições suaves, sem "virar página":** cards/telas surgem só com **fade de opacidade** (curto), nunca deslizando (`translateY`) — o deslize dá sensação de folhear e cansa a criança.
